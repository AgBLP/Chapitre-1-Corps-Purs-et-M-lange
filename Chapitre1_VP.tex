...
\begin{table*}
    ...
    \hline
    Photographie & \includegraphics[scale=0.6]{Images/Becher_huile_eau.jpg} & \includegraphics[scale=0.3]{Images/Becher_huile.jpg} & \includegraphics[scale=0.7]{Images/Becher_eau.jpg} & \includegraphics[scale=0.3]{Images/Becher_azote.png} \\
    \hline
